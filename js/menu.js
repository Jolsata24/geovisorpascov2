document.addEventListener('DOMContentLoaded', () => {
    ...
    // ==========================================
    // 1. CARGAR DATOS, KPIs Y BARRAS DE PROGRESO
    // ==========================================
    fetch('obras_pasco_geolocalizadas.json')
        ...
        .then(obras => {
            ...
            // ==========================================
            // 2. LÓGICA DEL MINI-MAPA DEL DASHBOARD
            // ==========================================
    ...
    // ==========================================
    // 3. LÓGICA DEL GRÁFICO CIRCULAR (Chart.js)
    // ==========================================
    ...
    if (canvasGrafico) {
        ...
        new Chart(ctx, {
            ...
            data: { 
                ...
                datasets: [{ data: [68, 32], backgroundColor: ['#10b981', '#f3f4f6'], borderWidth: 0, cutout: '75%' }] 
            },
